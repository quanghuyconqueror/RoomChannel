...
public class MySqlFunctions {
	...
	public User register(String username, String password, String email,
			String name, String city, String type) {
	...
	public ArrayList<Room> loadRoomByCity(String city) {
	...
	public Room postRoom(String address, String description, String latitude,
			String longitude, String city, String images, String cost,
			String userPostID) {
		Room room = null;
		Map<String, String> params = new LinkedHashMap<>();
